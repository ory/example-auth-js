...
[Ory example-auth-js Discussions](https://github.com/orgs/ory/discussions) or the
...
[open a well-written issue or discussion](https://github.com/ory/example-auth-js/issues):
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/example-auth-js/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory example-auth-js, please follow these
guidelines:
...
git clone git@github.com:ory/example-auth-js.git
